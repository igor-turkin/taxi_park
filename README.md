...
---
Необходимо проанализировать датасет с результатами эксперимента и решить несколько задач:
...
При работе с данными эксперимента я рассчитал все необходимые метрики для каждой группы и проанализировал те из них, которые позволяют дать ответы на поставленные задачи.. 
...
В итоге это привело к тому, что главная конверсия Order2Trip упала на **5%**, с **63%** до **58%**. Увеличение радиуса поиска оказало больше негативного эффекта чем положительного.
...
<img src="images/post_pie.png" alt="pic1" width="400">
...
### Дашбоард результатов эксперимента
