...
Датасет A/B теста находится в файле <u>taxi_dataset.csv</u>  
Описание данных датасета находится в файле <u>description.txt</u>  
Решения задач находятся в файле <u>taxi_park_ab_test.ipynb</u>   
